...
export default function ProfileSettings() {
    ...
    return <SettingsLayout title="Edit Profile" explain="Update your display name, avatar, and background image.">
        <div className="space-y-4 py-2">
            ...
            <button onClick={save} disabled={saving} className="w-full h-11 rounded-lg bg-[#1277d6] text-white! font-semibold text-base hover:bg-[#3596f1dd] disabled:opacity-50 mt-2">
